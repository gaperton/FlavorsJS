...
export declare type Mixin<T> = (new () => T) | T;
...
export declare namespace mixin {
    var extends: typeof mixins;
    var super: typeof superMixins;
    var nextAround: typeof callNextMethod;
    var applyNextAround: typeof applyNextMethod;
}
